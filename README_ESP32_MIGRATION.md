...
[![Status](https://img.shields.io/badge/status-Sprint%203%20in%20progress-yellow.svg)]()
...
> **Trạng thái code**: Sprint 0-3 đã viết xong, **build sạch** (`esp32/`, 0 lỗi 0 warning,
> RAM 9.8% / Flash 17.8%) nhưng **chưa nghiệm thu trên phần cứng thật** — theo Definition of
> Done bên dưới thì chưa được tính là Done. USB và BLE đã truyền dữ liệu thật; WiFi vẫn là
> **stub** (chọn được trong menu, chưa truyền dữ liệu) — hiện thực thật là Sprint 4-5.
